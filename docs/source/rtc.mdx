...
prefix length, underflow count, task provenance, and reset epoch. Enabling the
file adds synchronization needed for accurate CUDA phase timing; leave it unset
for normal deployment performance.
